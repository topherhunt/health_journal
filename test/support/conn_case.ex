defmodule HealthJournalWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use HealthJournalWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import HealthJournalWeb.ConnHelpers
      import HealthJournalWeb.EmailHelpers
